...
import { faCartPlus, faDollarSign, faHeadset, faUsers, faUserTie, faUtensils } from '@fortawesome/free-solid-svg-icons'
                ...
                <div className="row g-4">
                    ...
                    data-wow-delay="0.1s">
                        <div className="service-item rounded pt-3">
                            <div className="p-4">
                                <FontAwesomeIcon icon={faUsers} className="fa-3x text-warning mb-3"/>
                                <h5>
                                    Nft Club
                                </h5>
                                <p>
